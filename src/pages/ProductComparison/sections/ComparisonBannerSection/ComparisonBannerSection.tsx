...
export const ComparisonBannerSection = (): JSX.Element => {
  return (
    <section className="w-full h-[316px] relative">
      ...
      <div className="absolute top-[61px] left-1/2 transform -translate-x-1/2 w-[300px] h-[133px]">
        ...
        <img
          className="absolute top-0 left-[110px] w-[77px] h-[77px] object-cover"
